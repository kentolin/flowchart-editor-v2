...
1. [Shape System (Data Layer) - Bottom Layer](#1-shape-system-bottom-layer---pure-shape-definition)
2. [MVC Layer (Node Instance Layer) - Middle Layer](#2-mvc-layer-middle-layer---node-business-logic)
3. [Manager Layer (All Nodes Management) - Top Layer](#3-manager-layer-top-layer---all-nodes-management)
4. [Canvas Layer(SVG Container - Editor Layer)](#4-editor-canvas-layer---svg-container)
...
├─> Has static render(width, height, style) method
