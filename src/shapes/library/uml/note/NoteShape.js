export class NoteShape {
  ...
  render(container, node) {
    ...
    pathEl.setAttribute("fill", node.style?.fill || "#fff9c4");
    pathEl.setAttribute("stroke", node.style?.stroke || "#000");
    ...
    foldEl.setAttribute("fill", "none");
    foldEl.setAttribute("stroke", node.style?.stroke || "#000");
